...
const SpecialEventCard = ({ event, className = '' }) => {
    ...
    return (
        <div className={`bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 ${className} h-80 flex flex-col`}>
            ...
            <div className="absolute z-10 top-4 left-4">
                <div className="inline-flex items-center space-x-1 bg-red-500 text-white px-3 py-1 rounded-full text-xs font-bold">
                    <span>🔥</span>
                    <span>ĐẶC BIỆT</span>
                </div>
            </div>
                ...
                <div className="flex items-center justify-between pt-2">
                    ...
                    <div className="flex space-x-2">
                        ...
                        <button 
                            ...
                            className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg text-sm font-bold transition-colors duration-200"
                        >
                            Đặt vé
                        </button>
                    </div>
