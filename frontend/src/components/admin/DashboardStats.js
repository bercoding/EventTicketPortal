    ...
    const statCards = [
        {
            ...
            icon: '👥',
            color: 'from-pastel-500 to-pastel-600',
            bgColor: 'bg-pastel-50',
            textColor: 'text-pastel-600',
            change: '+12%',
            changeType: 'increase'
        },
        {
        ...
        },
        {
            ...
            icon: '🎯',
            color: 'from-pastel-600 to-pastel-700',
            bgColor: 'bg-pastel-100',
            textColor: 'text-pastel-700',
            change: '+15%',
            changeType: 'increase'
        },
        {
